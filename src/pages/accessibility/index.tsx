...
const AccessibilityPage: FC = () => {
  ...
  return (
    <div className='min-h-screen bg-gray-50 py-12'>
      <SEO
        title='Accessibility Statement | BetterSiquijor'
        description="Learn about BetterSiquijor's commitment to web accessibility, including WCAG compliance, accessibility features, and how to request assistance."
        keywords={[
          'accessibility',
          'WCAG',
          'screen reader',
          ...
          <div className='bg-white rounded-xl shadow-xs overflow-hidden mb-8'>
            <div className='p-6 md:p-8 border-b border-gray-200'>
              ...
              <p className='text-lg text-gray-800'>
                BetterSiquijor is committed to ensuring digital accessibility
            ...
            <div className='p-6 md:p-8'>
              ...
              <div className='prose prose-lg text-gray-800 mb-6'>
                <p>
                  ...
                  BetterSiquijor. If you encounter accessibility barriers or
